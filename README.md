...
![AWS](https://img.shields.io/badge/AWS-FF9900?style=flat&logo=amazonaws&logoColor=111)
![Docker](https://img.shields.io/badge/Docker-2496ED?style=flat&logo=docker&logoColor=white)
![PostgreSQL](https://img.shields.io/badge/PostgreSQL-336791?style=flat&logo=postgresql&logoColor=white)
![LangChain](https://img.shields.io/badge/LangChain-1C3C3C?style=flat&logoColor=34D399)
![OpenAI](https://img.shields.io/badge/OpenAI_APIs-10a37f?style=flat&logo=openai&logoColor=white)

---

## 🧠 What I build

Fullstack engineer, 15+ years, front-end leaning. I live in **Next.js and TypeScript**, back it with **Python** and Node, and ship it on AWS.

Most of my career has been about the same problem in different costumes: **getting messy real-world data into a system reliably, and putting a good interface on top of it.** Factory floors, logistics platforms, ad tech, fintech — the domain changes, the problem doesn't.

These days that means AI: RAG pipelines, LLM integrations, and Copilot experiences running in production.
